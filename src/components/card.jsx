    ...
    <div className="card cards__card">
      <div className="card__content">
        ...
        <div className="card-price card-price__grid">
          ...
          <p className="text card-price__text price price__grid-item">
            12 999 руб.
          </p>
          <span className="card-price__button">
            <svg
              className="svg card-price__svg plus plus__grid-item"
              width="12"
              height="12"
              viewBox="0 0 12 12"
              fill="none"
